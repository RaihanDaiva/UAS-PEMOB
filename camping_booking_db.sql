...
-- Dumping data for table camping_booking_db.bookings: ~0 rows (approximately)
INSERT IGNORE INTO `bookings` (`id`, `booking_code`, `user_id`, `campsite_id`, `check_in_date`, `check_out_date`, `num_people`, `num_tents`, `total_nights`, `price_per_night`, `subtotal`, `tax_amount`, `total_price`, `booking_status`, `special_requests`, `created_at`, `updated_at`) VALUES
	(1, 'BKG20251219158510', 4, 1, '2025-12-20', '2025-12-23', 4, 2, 3, 150000.00, 450000.00, 45000.00, 495000.00, 'pending', 'Near the lake if possible', '2025-12-19 09:49:45', '2025-12-19 09:49:45');
...
-- Dumping data for table camping_booking_db.campsites: ~12 rows (approximately)
INSERT IGNORE INTO `campsites` (`id`, `name`, `description`, `location_name`, `latitude`, `longitude`, `capacity`, `price_per_night`, `facilities`, `image_url`, `is_active`, `created_at`, `updated_at`) VALUES
	...
	(2, 'Beach Paradise Camp', 'Coastal camping experience with stunning beach views and water activities.', 'Pangandaran, West Java', -7.68450000, 108.65010000, 40, 200000.00, 'Beach access, Water sports, Restaurant, Security 24/7, Wifi', NULL, 1, '2025-12-18 12:28:02', '2025-12-18 12:28:02'),
	(3, 'Forest Adventure Camp', 'Experience nature in the heart of the forest with hiking trails and wildlife.', 'Sukabumi, West Java', -6.93060000, 106.92670000, 30, 175000.00, 'Hiking trails, Bonfire area, Nature guide, First aid station, Clean water source', NULL, 1, '2025-12-18 12:28:02', '2025-12-18 12:28:02'),
	(4, 'ye', 'yeet', 'bandung', -7.00000000, 107.00000000, 15, 12000.00, 'yet', NULL, 0, '2025-12-19 12:04:09', '2025-12-19 12:14:08'),
	(5, '123', 'descriptionsz', 'inyonyesya', -7.00000000, 107.00000000, 25, 120000.00, 'feature', NULL, 1, '2025-12-19 12:16:09', '2025-12-19 12:16:09'),
	(6, 'yaaayeeet', 'descriptionszasd', 'indonyoessia', -7.00000000, 107.00000000, 67, 676767.00, '6ix 7even', NULL, 0, '2025-12-19 12:18:08', '2025-12-19 12:19:03'),
	(7, 'zxc', 'sdw', 'zxc', 1.00000000, 23.00000000, 42, 124123.00, 'azx', NULL, 0, '2025-12-19 12:20:01', '2025-12-19 12:22:58'),
	(8, 'test3', 'Desc', 'test3', 1.00000000, 32.00000000, 32, 42111.00, 'Feat', NULL, 1, '2025-12-19 12:23:17', '2025-12-19 12:23:17'),
	(9, 'test4', 'Descriptuosnoi', 'test4', -7.00000000, 107.00000000, 23, 12000.00, 'FEatrure', NULL, 1, '2025-12-19 12:34:54', '2025-12-19 12:34:54'),
	(10, 'a', '43', 'z', 2.00000000, 3.00000000, 2, 12.00, '2', NULL, 1, '2025-12-19 12:40:17', '2025-12-19 12:40:17'),
	(11, 'Edditted 2', 'zxcb', 'zdbzdsb', 12.00000000, 21.00000000, 21, 4000.00, '23', NULL, 1, '2025-12-19 12:47:15', '2025-12-19 13:08:00'),
	(12, 'Inserted 4', '2342', 'srea', 12.00000000, 32.00000000, 32, 42.00, '1341', NULL, 1, '2025-12-19 13:08:36', '2025-12-19 13:08:36');
...
-- Dumping data for table camping_booking_db.notifications: ~4 rows (approximately)
INSERT IGNORE INTO `notifications` (`id`, `user_id`, `title`, `message`, `notification_type`, `is_read`, `related_id`, `created_at`) VALUES
	(1, 2, 'Account Approved', 'Congratulations! Your account has been approved. You can now start booking camping sites.', 'approval', 0, NULL, '2025-12-18 12:36:39'),
	(2, 3, 'Account Approved', 'Congratulations! Your account has been approved. You can now start booking camping sites.', 'approval', 0, NULL, '2025-12-19 02:58:13'),
	(3, 4, 'Account Approved', 'Congratulations! Your account has been approved. You can now start booking camping sites.', 'approval', 0, NULL, '2025-12-19 04:19:09'),
	(4, 4, 'Booking Created Successfully', 'Your booking (BKG20251219158510) has been created. Please complete the payment.', 'booking', 0, 1, '2025-12-19 09:49:45');
...
-- Dumping data for table camping_booking_db.users: ~5 rows (approximately)
INSERT IGNORE INTO `users` (`id`, `email`, `password_hash`, `full_name`, `phone_number`, `role`, `registration_status`, `profile_image_url`, `address`, `created_at`, `updated_at`, `last_login`, `is_active`) VALUES
	(1, 'admin@camping.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5XD.7Uh6qqZ1u', 'Admin Camping', '081234567890', 'admin', 'approved', NULL, NULL, '2025-12-18 12:28:02', '2025-12-18 12:28:02', NULL, 1),
	(2, 'user@example.com', '$2b$12$rfNqLVzxEBY2yO16kgduH.0QpXPJ0FvbSYVeDFnsa87Be/71eof0S', 'John Doe', '081234567890', 'client', 'approved', NULL, 'Jl. Merdeka No. 123', '2025-12-18 12:34:58', '2025-12-18 12:36:39', NULL, 1),
	(3, 'admin21@gmail.com', '$2b$12$BBKfT2WWhk5Re9.YiVshnOV4LdsOnVyx0lKrgzknxleaYeHnuaGwC', 'admin21', '08123456789', 'admin', 'approved', NULL, '', '2025-12-19 02:57:38', '2025-12-19 02:58:13', NULL, 1),
	(4, 'user12@gmail.com', '$2b$12$envAU7/2WN7eerbXInXyNOO1X6ZjMRZrclJipt3WC1qRIQlV1YF.O', 'user12', '08124356789', 'client', 'approved', NULL, '', '2025-12-19 03:17:43', '2025-12-19 04:19:09', NULL, 1),
